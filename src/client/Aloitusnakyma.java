...
public class Aloitusnakyma extends JFrame{
	...
	public Aloitusnakyma(String nimi){
		...
		kuva1 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/rage.jpg"))); 
		rage = new JLabel(kuva1);

		kuva2 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/woodoo.jpg"))); 
		woodoo = new JLabel(kuva2);

		kuva3 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/pirate.jpg"))); 
		pirate = new JLabel(kuva3);

		kuva4 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/amatson.jpg"))); 
		amatson = new JLabel(kuva4);

		kuva5 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/khan.jpg"))); 
		khan = new JLabel(kuva5);

		kuva6 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/res/blue.jpg"))); 
