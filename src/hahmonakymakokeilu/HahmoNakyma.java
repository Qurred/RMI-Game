...
public class HahmoNakyma extends JPanel {
	...
	public HahmoNakyma(Dimension dim){
		...
		this.add(piilota); //Palauttaa takas perusn‰kym‰‰n
		//Tausta
		tausta = new JLabel();
	...
	public void alustamuut(){
		...
		//Esitett‰v‰n nimikomponentin alustus ja arvojen asetukset
		...
		//Esitett‰v‰n luokkakomponentin alustus ja arvojen asetukset
		...
		//Esitett‰v‰n tarinakomponentin alustus ja arvojen asetukset
	 ...
	 * Paneelista lˆytyy JLabel, joka piilottaa t‰m‰n n‰kym‰n tarvittaessa.
	 * @param totuus
	 * @deprecated
	 */
